...
//  Ext
//
//  Created by guojian on 2023/1/28.
//
...
open class VisualEffectView: UIVisualEffectView {
    ...
    private lazy var blurEffect: UIBlurEffect? = {
        guard let BlurEffectType = NSClassFromString("_UICustomBlurEffect") as? UIBlurEffect.Type else { return nil }
        return BlurEffectType.init()
    }()
